...
public class Archivo {
    ...
    String catalogoCanciones="Golden Album;Romeo Santos;Bachata;2000;Tuyo;Perjurio;Centavito"
            + "\n";
    
    
     /** 
     * Metodo que funciona para ademas de 
     * escribir en un Archivo , sino existe lo crea
     * se da el Nombre del Archivo como parametro para 
     * crear el objeto Archivo y posteriormente escribir en el
     * archivo.
     *1
     * @param nombreArchivo
     * @param informacion 
