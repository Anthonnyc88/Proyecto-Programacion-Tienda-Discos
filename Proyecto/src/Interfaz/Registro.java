...
public class Registro extends javax.swing.JFrame {
    ...
    public void enviarCorreo() {
        ...
        a.setDestino(textCorreo.getText().trim());
        a.setNombreArchivo("Azul.jpg");
        a.setRutaArchivo("Azul.jpg");
        a.setAsunto(" Su Registro de Usuario ha sido un Exitoso !!!");
    ...
    private void btnRegistrarseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarseActionPerformed
        ...
        while (!(textNombre.getText().length() == 0 || textCedula.getText().length() == 0 || textContraseña.getText().length() == 0 || textCorreo.getText().length() == 0)) {
            ...
            //Aqui llama el metodo de enviar el correo al usuario que se registro
            enviarCorreo();
